...
namespace QnSProjectAward.Logic.Entities.Modules.Base
{
    partial class IdentitySetting : IdentityEntity
    {
    }
}
namespace QnSProjectAward.Logic.Entities.Modules.Base
{
    using System;
    partial class IdentitySetting : QnSProjectAward.Contracts.Modules.Base.IIdentitySetting
    {
        ...
        public override bool Equals(object obj)
        {
            if (obj is not QnSProjectAward.Contracts.Modules.Base.IIdentitySetting instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(QnSProjectAward.Contracts.Modules.Base.IIdentitySetting other)
        {
            if (other == null)
            {
                return false;
