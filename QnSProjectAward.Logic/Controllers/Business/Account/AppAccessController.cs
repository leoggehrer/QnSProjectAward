...
using QnSProjectAward.Logic.Controllers.Persistence.Account;
using QnSProjectAward.Logic.Entities.Business.Account;
...
#pragma warning restore IDE0017 // Simplify object initialization
        ...
        {
            //Delete all costs that are no longer included in the list.
            var identXRoles = await IdentityXRoleController.ExecuteQueryAllEntitiesAsync(e => e.IdentityId == id);
