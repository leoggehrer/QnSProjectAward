//@QnSGeneratedCode
namespace QnSProjectAward.Transfer.Business.Account
{
    partial class IdentityUser : OneToAnotherModel<QnSProjectAward.Contracts.Persistence.Account.IIdentity, QnSProjectAward.Transfer.Persistence.Account.Identity, QnSProjectAward.Contracts.Persistence.Account.IUser, QnSProjectAward.Transfer.Persistence.Account.User>
    {
    }
}
namespace QnSProjectAward.Transfer.Business.Account
...
namespace QnSProjectAward.Transfer.Business.Account
{
    partial class AppAccess : OneToManyModel<QnSProjectAward.Contracts.Persistence.Account.IIdentity, QnSProjectAward.Transfer.Persistence.Account.Identity, QnSProjectAward.Contracts.Persistence.Account.IRole, QnSProjectAward.Transfer.Persistence.Account.Role>
    {
    }
}
namespace QnSProjectAward.Transfer.Business.Account
