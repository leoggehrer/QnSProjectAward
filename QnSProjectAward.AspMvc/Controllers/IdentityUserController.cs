...
using QnSProjectAward.AspMvc.Models.Persistence.Account;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
using Contract = QnSProjectAward.Contracts.Business.Account.IIdentityUser;
using Model = QnSProjectAward.AspMvc.Models.Business.Account.IdentityUser;
...
namespace QnSProjectAward.AspMvc.Controllers
{
    public partial class IdentityUserController : AccessController
    {
        ...
        public async Task<IActionResult> EditAsync(int id, Identity identity, User user, IFormCollection formCollection)
        {
            ...
            model.OneItem.CopyProperties(identity);
            model.AnotherItem.CopyProperties(user);
