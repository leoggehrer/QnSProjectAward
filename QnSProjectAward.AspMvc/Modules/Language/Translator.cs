...
using QnSProjectAward.AspMvc.Models.Modules.Language;
...
using AccountManger = QnSProjectAward.Adapters.Modules.Account.AccountManager;

namespace QnSProjectAward.AspMvc.Modules.Language
{
    public partial class Translator
    {
        ...
        private static string CreatePredicate() => $"AppName.Equals(\"{nameof(QnSProjectAward)}\") && {nameof(KeyLanguage)} == {(int)KeyLanguage} && {nameof(ValueLanguage)} == {(int)ValueLanguage}";
            ...
            if (handled == false)
            {
                ...
                try
                {
                    ...
                    foreach (var item in keyValuePairs.Where(i => i.Key.HasContent()))
                    {
                        ...
                        if (entity != null)
                        {
                            entity.AppName = nameof(QnSProjectAward);
